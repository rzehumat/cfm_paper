...
\begin{center}
\captionof{table}{Example of a table and table caption.} %This creates a caption for a table
...
\hhline{===} %This is the horizontal line after the table headers.
...
\begin{center}
    \includegraphics[width = \columnwidth]{Figures/CFM test.png}
    \captionof{figure}{Example of a figure and a figure caption} %Creates a figure caption.
